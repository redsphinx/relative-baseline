...
class Googlenet3TConv_explicit(torch.nn.Module):
    ...
    def forward(self, x, device, stop_at=None, aux=True, gradcam=False, which_pass=1, extra_pass_2=None):
        # set aux=False during inference (test time)
        ...
        if condition_1 or condition_2:
            ...
            h4 = self.maxpool13(x)  # branch 4.0
            h4 = self.conv59(h4)  # branch 4.1
            h4 = self.bn59(h4)
...
class Googlenet3DConv_explicit(torch.nn.Module):
    ...
    def forward(self, x, stop_at=None, aux=True, gradcam=False, which_pass=1, extra_pass_2=None):
        # set aux=False during inference (test time)
