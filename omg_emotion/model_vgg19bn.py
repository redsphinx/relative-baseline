...
class VGG19BN_Explicit_3D(torch.nn.Module):
    def __init__(self):
        super(VGG19BN_Explicit_3D , self).__init__()

        self.conv1 = Conv3d(in_channels=3, out_channels=64, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn1 = BatchNorm3d(64)
        self.conv2 = Conv3d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn2 = BatchNorm3d(64)
        self.maxpool1 = MaxPool3d(kernel_size=2, padding=0, stride=2)

        self.conv3 = Conv3d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn3 = BatchNorm3d(128)
        self.conv4 = Conv3d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn4 = BatchNorm3d(128)
        self.maxpool2 = MaxPool3d(kernel_size=2, padding=0, stride=2)

        self.conv5 = Conv3d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn5 = BatchNorm3d(256)
        self.conv6 = Conv3d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn6 = BatchNorm3d(256)
        self.conv7 = Conv3d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn7 = BatchNorm3d(256)
        self.conv8 = Conv3d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn8 = BatchNorm3d(256)
        self.maxpool3 = MaxPool3d(kernel_size=2, padding=0, stride=2)

        self.conv9 = Conv3d(in_channels=256, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn9 = BatchNorm3d(512)
        self.conv10 = Conv3d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn10 = BatchNorm3d(512)
        self.conv11 = Conv3d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn11 = BatchNorm3d(512)
        self.conv12 = Conv3d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn12 = BatchNorm3d(512)
        self.maxpool4 = MaxPool3d(kernel_size=2, padding=0, stride=1)

        self.conv13 = Conv3d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn13 = BatchNorm3d(512)
        self.conv14 = Conv3d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn14 = BatchNorm3d(512)
        self.conv15 = Conv3d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn15 = BatchNorm3d(512)
        self.conv16 = Conv3d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=True)
        self.bn16 = BatchNorm3d(512)
        self.maxpool5 = MaxPool3d(kernel_size=2, padding=0, stride=2)
