...
def plot_results_datapoints_accuracy():
    ...
    model_2_acc = np.array(
        [0.3737833333, 0.4982566667, 0.6247766667, 0.6710766667, 0.7495833333, 0.8366866667, 0.9592766667, 0.97637, 0.98757])
    labels_2 = [0.374, 0.498, 0.625, 0.671, 0.75, 0.837, 0.96, 0.977, 0.988]
    loc_2_y = [-0.03, -0.04, -0.04, -0.04, -0.04, 0.02, 0.01, 0.01, 0.01]
    loc_2_x = [1, 0, 0, 0, 0, -10, -50, -250, -400]
    model_2_stde = np.array([0.0122180041  ,0.01310738272 ,0.01074435116 ,0.009515661574,0.008344632451,0.005919209282,0.002494984673,0.001364422141, 0.0007161649407])
    ...
    model_3_acc = np.array(
        [0.47685, 0.58781, 0.6681366667, 0.7206133333, 0.7725033333, 0.8287233333, 0.9254366667, 0.9677166667, 0.9718333333])
    labels_3 = [0.477, 0.588, 0.669, 0.721, 0.773, 0.829, 0.925, 0.968, 0.972]
    loc_3_y = [0.03, 0.03, 0.015, 0.015, 0.02, -0.05, -0.04, -0.04, -0.03]
    loc_3_x = [-2, -5, -9, -15, -10, -10, -50, -200, -350]
    model_3_stde = np.array([0.01387213494 ,0.01078555964 ,0.009109147397,0.007932831543,0.006682841184,0.007343126315,0.005807509474,0.002008161588, 0.00220658778])
...
m2_mean = [0.3737833333, 0.4982566667, 0.6247766667, 0.6710766667, 0.7495833333, 0.8366866667, 0.9592766667, 0.97637, 0.98757]
m2_std = [0.06692076451,0.07179209187,0.05884923496,0.05211942494,0.04570543427,0.03242084446,0.01366559386,0.007473247844, 0.003922596929]
m3_mean = [0.47685, 0.58781, 0.6681366667, 0.7206133333, 0.7725033333, 0.8287233333, 0.9254366667, 0.9677166667, 0.9718333333]
m3_std = [0.07598081227,0.05907494308,0.04989285509,0.04344990781,0.03660342865,0.04021995925,0.03180903942,0.01099915401, 0.01208597902]
nums = [10, 20, 30, 40, 50, 100, 500, 1000, 2000]
