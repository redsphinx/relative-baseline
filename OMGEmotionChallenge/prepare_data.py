...
def dl_youtube(link, target_file):
    # command = "youtube-dl -f best --merge-output-format mp4 --restrict-filenames --socket-timeout 20 -iwc --write-info-json --write-annotations --prefer-ffmpeg %s -o %s" % (link, target_file)
...
def prepare_data(file, target_dir):
    target_dir = '/scratch/users/gabras/data/omg_emotion'
